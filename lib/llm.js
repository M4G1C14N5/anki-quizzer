...
function stripCodeFences(s) {
  if (!s) return s;
  // Strip reasoning-model <think>...</think> blocks (MiniMax-M3 always emits
  // these even with response_format=json_object; ignore-greedy across the
  // whole string in case the model interleaves multiple).
